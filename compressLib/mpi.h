...
OMPI_DECLSPEC int MPI_Csend(char *cBuf, long cBufLen, char *buf, long bufLen, int *dest, int numDest,  MPI_Comm comm,  const unsigned char compressAlg);

OMPI_DECLSPEC int MPI_Csend_Online(char *cBuf, long cBufLen, char *buf, long bufLen, int *dest, int numDest,  MPI_Comm comm,  const unsigned char compressAlg);
...
OMPI_DECLSPEC int MPI_Crecv(char *cBuf, long cBufLen, char *buf, long bufLen, int source, MPI_Comm comm);

OMPI_DECLSPEC int PMPI_Crecv(char *cBuf, long cBufLen, char *buf, long bufLen, int source, MPI_Comm comm) ;


OMPI_DECLSPEC int PMPI_Crecv_Online(char *buf, long bufLen, int source, MPI_Comm comm);

OMPI_DECLSPEC int MPI_Crecv_Online(char *buf, long bufLen, int source, MPI_Comm comm);
...
OMPI_DECLSPEC int PMPI_Csend(char *cBuf, long cBufLen, char *buf, long bufLen, int *dest, int numDest,  MPI_Comm comm,  const unsigned char compressAlg);

OMPI_DECLSPEC int PMPI_Csend_Online(char *cBuf, long cBufLen, char *buf, long bufLen, int *dest, int numDest,  MPI_Comm comm,  const unsigned char compressAlg);
